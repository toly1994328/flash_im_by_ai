...
上传图片文件。支持 jpg/png/gif/webp，最大 10MB。
...
| hash | string | 是 | 文件 SHA-1 hex（40字符） |

## Response `200`

```json
{"file_id":9,"original_url":"/uploads/original/2026/06/cf8c75aa-cd6c-48e3-a144-653ab55a1940.png","thumbnail_url":"/uploads/thumb/2026/06/cf8c75aa-cd6c-48e3-a144-653ab55a1940.webp","width":1,"height":1,"size":69,"format":"png","is_dedup":false}
```
