...
| action | string | 是 | 动作：confirm |

```json
{"scan_token": "1a7d3f1e-2e4c-4ed6-b208-7977098d87e3", "action": "confirm"}
```
...
curl -s -X POST "http://127.0.0.1:9600/auth/scan/confirm"
  ...
  -d '{"scan_token": "1a7d3f1e-2e4c-4ed6-b208-7977098d87e3", "action": "confirm"}'
```